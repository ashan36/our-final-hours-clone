 ...
 * NotificationsManager.DefaultNotifier.PostNotification(new Notification(this, "OnExampleEvent"));
 * NotificationsManager.DefaultNotifier.PostNotification(new Notification(this, "OnExampleEvent", anyObject));
 * 
